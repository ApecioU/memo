...
## Use case
There are tasks that, while essential, quickly become repetitive and a bit tedious.
...
After doing this a few times, you realize how repetitive and time-consuming this process becomes, especially when there are multiple computers to configure. That’s when I thought: Why not automate all of this?
