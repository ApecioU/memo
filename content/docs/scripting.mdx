...
## Use case
Il y a des tâches qui, bien qu’essentielles, deviennent vite répétitives et un peu fastidieuses. 

Par exemple, dans ma première alternance au sein d'un groupe d'universités, lorsqu’on reçoit un nouveau PC à configurer, une des étapes courantes consiste à installer un antivirus. 
...
Au bout de quelques fois, tu réalises à quel point cette procédure devient répétitive et chronophage, surtout lorsqu’il y a plusieurs ordinateurs à configurer. C’est là que je me suis dit : Pourquoi ne pas automatiser tout ça ?
...
Et ça, c’est ce qui me plaît dans le scripting : gagner du temps, réduire les erreurs, et surtout, rendre les tâches plus efficaces.